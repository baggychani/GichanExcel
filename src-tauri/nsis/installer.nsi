...
!define LEGACYPRODUCTNAME "기찬엑셀"
!define LEGACYMANUKEY "Software\gichan"
!define LEGACYMANUPRODUCTKEY "${LEGACYMANUKEY}\${LEGACYPRODUCTNAME}"
...
Function PageReinstall
  ...
  ${If} "$R0$R1" == ""
    ; Earlier releases used the Korean product name in Windows registry keys.
    ; Keep detecting it so the first GichanExcel-branded update replaces the
    ; old install instead of creating a side-by-side app.
...
Function PageLeaveReinstall
  ; Upgrades should proceed without showing a maintenance choice page.
  ${If} $R0 = 1
